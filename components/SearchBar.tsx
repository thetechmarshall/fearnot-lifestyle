    ...
    <Dialog open={showSearch} onOpenChange={() => setShowSearch(!showSearch)}>
      ...
      <DialogContent className="!max-w-5xl min-h-[90vh] max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="w-full h-full overflow-y-scroll border border-darkColor/20 rounded-md">
          <div>
            {loading ? (
              <p className="flex items-center px-6 py-10 gap-1 text-center font-semibold text-yellow-600">
              ...
              <div className="text-center text-sm py-10 font-normal tracking-wide">
                {search && !loading ? (
                  <p>
                    No match with the keyword{" "}
                  ...
                  <p className="flex text-green-600 items-center justify-center gap-1">
                    <Search className="w-5 h-5" /> Search and explore our
                    products
                  </p>
                )}
              </div>
